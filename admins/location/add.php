...
<?php 
    if(isset($_POST['submitSave'])){
        ...
        $location =  $shop->addChild('location');
        $location->addAttribute('id', $_POST['id']);
        $location->addChild('local', $_POST['local']);
                                ...
                                <div class="x_panel">
                                    <div class="x_content">
                                        ...
                                        <form method="POST" id="demo-form2" data-parsley-validate
                                            ...
                                            <div class="item form-group">
                                                <label
                                                    class="col-form-label col-md-3 col-sm-3 label-align">Location</label>
                                                <div class="col-md-6 col-sm-6 ">
