...
<?php 
    if(isset($_GET['action'])){
        ...
        $index =  0;
        $i = 0 ;
        foreach ($cafe_shop->location as $location){
            if($location['id']==$id){
                $index = $i;
                break;
            }
        ...
        unset ($cafe_shop->location[$index]);
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 ">
                        ...
                        <div class="row x_title">
                            <div class="col-md-6">
                                <h2>
                                    <a href="add.php">Add Location <i class="fas fa-plus"></i></a>
                                </h2>
                            </div>
                        </div>
                        <div class="dashboard_graph">
                            <table class="table">
                                ...
                                <tbody>
                                    <?php foreach ($cafe_shop->location as $location) { ?>
                                    <tr>
                                        <td><?php echo $location['id'] ; ?></td>
                                        <td><?php echo $location->local ; ?></td>
                                        <td>
                                            <a class="edit" href="edit.php?id=<?php echo $location['id'];?>"><i
                                                    class="fas fa-pen"></i></a>
                                            <a class="delete"
                                                href="index.php?action=delete&id=<?php echo $location['id'];?>"
