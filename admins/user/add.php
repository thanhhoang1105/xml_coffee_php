...
<?php 
    if(isset($_POST['submitSave'])){
        ...
        $login_details =  $shop->addChild('login_details');
        $login_details->addAttribute('id', $_POST['id']);
        $login_details->addChild('login', $_POST['login']);
        $login_details->addChild('password', $_POST['password']);
