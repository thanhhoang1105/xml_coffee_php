...
<?php 
    if(isset($_POST['submitSave'])){
        ...
        $wrapper =  $shop->addChild('wrapper');
        $wrapper->addAttribute('id', $_POST['id']);
        $wrapper->addChild('image_left', $_POST['image_left']);
        $wrapper->addChild('image_right', $_POST['image_right']);
        $wrapper->addChild('title', $_POST['title']);
        $wrapper->addChild('text', $_POST['text']);
        $wrapper->addChild('button', $_POST['button']);
