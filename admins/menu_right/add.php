...
<?php 
    if(isset($_POST['submitSave'])){
        ...
        $menu_right =  $shop->addChild('menu_right');
        $menu_right->addAttribute('id', $_POST['id']);
        $menu_right->addChild('image', $_POST['image']);
        $menu_right->addChild('name', $_POST['name']);
        $menu_right->addChild('description', $_POST['description']);
        $menu_right->addChild('price', $_POST['price']);
