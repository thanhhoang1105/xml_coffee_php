...
<?php 
    if(isset($_GET['action'])){
        ...
        unset ($cafe_shop->menu_right[$index]);
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 ">
                        ...
                        <div class="row x_title">
                            <div class="col-md-6">
                                <h2>
                                    <a href="add.php">Add Menu Right <i class="fas fa-plus"></i></a>
                                </h2>
                            </div>
                        </div>
                        <div class="dashboard_graph">
                            <table class="table">
                                ...
                                <tbody>
                                    <?php foreach ($cafe_shop->menu_right as $menu_right) { ?>
                                    <tr>
                                        <td><?php echo $menu_right['id'] ; ?></td>
                                        <td><?php echo '<img src="'.$xml_url . '' . $menu_right -> image . '" class="img_with">' ?>
                                        </td>
                                        <td><?php echo $menu_right->name ; ?></td>
                                        <td><?php echo $menu_right->description ; ?></td>
                                        <td><?php echo $menu_right->price ; ?></td>
                                        <td>
                                            <a class="edit" href="edit.php?id=<?php echo $menu_right['id'];?>"><i
                                                    class="fas fa-pen"></i></a>
                                            <a class="delete"
                                                href="index.php?action=delete&id=<?php echo $menu_right['id'];?>"
