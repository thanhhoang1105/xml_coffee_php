...
<?php 
    if(isset($_POST['submitSave'])){
        ...
        $gallery =  $shop->addChild('gallery');
        $gallery->addAttribute('id', $_POST['id']);
        $gallery->addChild('image', $_POST['image']);
        $gallery->addChild('name', $_POST['name']);
        $gallery->addChild('description', $_POST['description']);
        $gallery->addChild('button', $_POST['button']);
