...
<?php 
    if(isset($_POST['submitSave'])){
        ...
        $contact =  $shop->addChild('contact');
        $contact->addAttribute('id', $_POST['id']);
        $contact->addChild('phone', $_POST['phone']);
        $contact->addChild('email', $_POST['email']);
        $contact->addChild('map', $_POST['map']);
                                ...
                                <div class="x_panel">
                                    <div class="x_content">
                                        ...
                                        <form method="POST" id="demo-form2" data-parsley-validate
                                            ...
                                            <div class="item form-group">
                                                <label class="col-form-label col-md-3 col-sm-3 label-align">Map</label>
                                                <div class="col-md-6 col-sm-6 ">
