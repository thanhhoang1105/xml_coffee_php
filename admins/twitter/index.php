...
<?php 
    if(isset($_GET['action'])){
        ...
        $index =  0;
        $i = 0 ;
        foreach ($cafe_shop->twitter as $twitter){
            if($twitter['id']==$id){
                $index = $i;
                break;
            }
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 ">
                        ...
                        <div class="row x_title">
                            <div class="col-md-6">
                                <h2>
                                    <a href="add.php">Add Twitter <i class="fas fa-plus"></i></a>
                                </h2>
                            </div>
                        </div>
                        <div class="dashboard_graph">
                            <table class="table">
                                ...
                                <tbody>
                                    <?php foreach ($cafe_shop->twitter as $twitter) { ?>
                                    <tr>
                                        <td><?php echo $twitter['id'] ; ?></td>
                                        <td><?php echo $twitter->link ; ?></td>
                                        <td>
                                            <a class="edit" href="edit.php?id=<?php echo $twitter['id'];?>"><i
                                                    class="fas fa-pen"></i></a>
                                            <a class="delete"
                                                href="index.php?action=delete&id=<?php echo $twitter['id'];?>"
