                    ...
                    <div class="col-md-12 col-sm-12 ">
                        ...
                        <div class="dashboard_graph">
                            <table class="table">
                                ...
                                <tbody>
                                    <?php foreach ($cafe_shop->header as $header) { ?>
                                    <tr>
                                        <td><?php echo $header['id'] ; ?></td>
                                        <td><?php echo $header->name ; ?></td>
                                        <td>
                                            <a class="edit" href="edit.php?id=<?php echo $header['id'];?>"><i
                                                    class="fas fa-pen"></i></a>
                                            <a class="delete"
                                                href="index.php?action=delete&id=<?php echo $header['id'];?>"
