...
<?php 
    if(isset($_GET['action'])){
        ...
        $index =  0;
        $i = 0 ;
        foreach ($cafe_shop->product as $product){
            if($product['id']==$id){
                $index = $i;
                break;
            }
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 ">
                        ...
                        <div class="row x_title">
                            <div class="col-md-6">
                                <h2>
                                    <a href="add.php">Add Product <i class="fas fa-plus"></i></a>
                                </h2>
                            </div>
                        </div>
                        <div class="dashboard_graph">
                            <table class="table">
                                ...
                                <tbody>
                                    <?php foreach ($cafe_shop->product as $product) { ?>
                                    <tr>
                                        <td><?php echo $product['id'] ; ?></td>
                                        <td><?php echo '<img src="'.$xml_url . '' . $product -> image . '" class="img_with">' ?>
                                        </td>
                                        <td><?php echo $product->name ; ?></td>
                                        <td><?php echo $product->description ; ?></td>
                                        <td>
                                            <a class="edit" href="edit.php?id=<?php echo $product['id'];?>"><i
                                                    class="fas fa-pen"></i></a>
                                            <a class="delete"
                                                href="index.php?action=delete&id=<?php echo $product['id'];?>"
