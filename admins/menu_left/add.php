...
<?php 
    if(isset($_POST['submitSave'])){
        ...
        $menu_left =  $shop->addChild('menu_left');
        $menu_left->addAttribute('id', $_POST['id']);
        $menu_left->addChild('image', $_POST['image']);
        $menu_left->addChild('name', $_POST['name']);
        $menu_left->addChild('description', $_POST['description']);
        $menu_left->addChild('price', $_POST['price']);
