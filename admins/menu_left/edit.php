...
<?php 
    ...
    if(isset($_POST['submitSave'])){
        foreach ($cafe_shop->menu_left as $menu_left){
            if($menu_left['id']==$_POST['id']){
                $menu_left->image = $_POST['image'];
                $menu_left->name = $_POST['name'];
                $menu_left->description = $_POST['description'];
                $menu_left->price = $_POST['price'];
                break;
            }
        }
    ...
    foreach ($cafe_shop->menu_left as $menu_left){
        if($menu_left['id']==$_GET['id']){
           $id = $menu_left['id'];
           $image = $menu_left->image;
           $name = $menu_left->name;
           $description = $menu_left->description;
           $price = $menu_left->price;
           break;
        }
    }
?>
